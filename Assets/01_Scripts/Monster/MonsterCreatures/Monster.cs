...
public class Monster : MonoBehaviourPun
{
	...
	public StateMachine<Monster, MonsterStateType> StateMachine => stateMachine;
	...
	protected void Start()
	{
		...
		stateMachine = new StateMachine<Monster, MonsterStateType>();
		states = new Dictionary<MonsterStateType, State<Monster>>
		{
		...
		stateMachine.Setup(this, states[MonsterStateType.Patrol], states);
