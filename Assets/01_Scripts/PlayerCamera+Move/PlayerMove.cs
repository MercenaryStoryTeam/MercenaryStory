...
{
	[Header("이동 속도")] [SerializeField] private float moveSpeed = 5f;

	[Header("Virtual Camera 할당")] [SerializeField]
	private Transform cameraTransform;

	[Header("Die 애니메이션 재생 시간")] [SerializeField]
	private float dieAnimationDuration = 2f;

	[Header("콤보 타이머")] [SerializeField] private float comboResetTime = 1.0f;

	[Header("씬 목록")] [SerializeField]
